...
class NeoPatterns : public Adafruit_NeoPixel
{
    ...
    static const uint32_t yellowColor = Color( 255, 255, 0); 
    static const uint32_t white50Color = Color(128, 128, 128);
    static const uint32_t whiteColor = Color(255,255,255);
